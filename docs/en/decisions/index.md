...
| **[ADP-013](/en/decisions/adp-013)** | WebAssembly Execution Substrate & Self-Hosting | Approved | Freezing v0.1.0 in legacy branch, migrating to WebAssembly (Wasm 2.0 / WASI), and self-hosting roadmap. |
